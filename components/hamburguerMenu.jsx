    ...
    return(
        <div className="fixed top-5 left-5 z-50">
            <button onClick={handleClick}>
                <MenuIcon size={40} className="text-black hover:text-black" />
            </button>
            
            {isOpen && (
                <div className='bg-[#4A515E] flex flex-col p-2 absolute top-12 left-0 min-w-[150px] rounded-lg shadow-xl'>
                    ...
                    <button onClick={() => scrollToSection("projetos")} className='text-left p-2 hover:bg-[#6B6872] rounded transition-colors'>
                        Projetos
                    </button>
